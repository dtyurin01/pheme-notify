...
/**
 * Circuit Breaker configuration for notification providers. Bound from {@code
 * pheme.resilience.email.*} in application.yaml.
 */
@Getter
@Validated
...
public class ResilienceProperties {
  ...
  @NotNull @PositiveDuration private final Duration waitDurationInOpenState;
