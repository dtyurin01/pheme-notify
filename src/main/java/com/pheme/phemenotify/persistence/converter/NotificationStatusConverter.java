...
public class NotificationStatusConverter
    implements AttributeConverter<NotificationStatus, PGobject> {
  ...
  public PGobject convertToDatabaseColumn(NotificationStatus status) {
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "Failed to convert NotificationStatus to PostgreSQL enum", e);
    }
  }
