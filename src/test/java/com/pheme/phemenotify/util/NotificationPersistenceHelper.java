...
public class NotificationPersistenceHelper {
    ...
    public static void saveWithDate(NotificationRepository repo, EventType eventType,
                                    Instant createdAt, Channel channel,
    ...
    public static void saveWithDateAndType(NotificationRepository repo,
                                           Instant createdAt, Channel channel,
                                           NotificationStatus status, String key,
                                           EventType eventType) {
        Notification saved = repo.save(buildNotification(key, channel, status, eventType));
    ...
    public static Notification buildNotification(String key, Channel channel,
                                                 NotificationStatus status, EventType eventType) {
