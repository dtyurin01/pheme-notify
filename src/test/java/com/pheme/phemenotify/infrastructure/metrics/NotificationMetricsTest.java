...
public class NotificationMetricsTest {
    ...
    void shouldIncrementSentCounter_whenIncrementSentCalled(){
        ...
        double count = registry.get("notifications.sent")
            .tag("channel", "EMAIL")
            .counter()
            .count();
    ...
    void shouldIncrementFailedCounter_whenIncrementFailedCalled(){
        ...
        double count = registry.get("notifications.failed")
            .tag("channel", "SMS")
            .counter()
            .count();
    ...
    void shouldNotAffectOtherChannels_whenIncrementingOneChannel()
    {
        ...
        double smsCount =
            registry.get("notifications.sent")
                .tag("channel", "SMS")
                .counter()
                .count();
    ...
    void shouldRecordSendDuration_whenRecordSendDurationCalled() {
        ...
        Timer timer = registry.get("notification.send.duration")
            .tag("channel", "PUSH")
            .timer();
